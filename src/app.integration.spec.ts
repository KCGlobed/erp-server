...
describe('AppModule (Integration)', () => {
  ...
  const mockPrismaService = {
    ...
    user: { findMany: jest.fn(), findUnique: jest.fn(), create: jest.fn(), deleteMany: jest.fn() },
    ...
    academicYear: { findMany: jest.fn(), create: jest.fn(), deleteMany: jest.fn() },
    attendance: { findMany: jest.fn(), create: jest.fn(), deleteMany: jest.fn() },
    exam: { findMany: jest.fn(), create: jest.fn(), deleteMany: jest.fn() },
    examResult: { findMany: jest.fn(), create: jest.fn(), deleteMany: jest.fn() },
    feeStructure: { findMany: jest.fn(), create: jest.fn(), deleteMany: jest.fn() },
    feePayment: { findMany: jest.fn(), create: jest.fn(), deleteMany: jest.fn() },
    refreshToken: { findMany: jest.fn(), create: jest.fn(), deleteMany: jest.fn() },
    book: { findMany: jest.fn(), create: jest.fn(), deleteMany: jest.fn() },
    notification: { findMany: jest.fn(), create: jest.fn(), deleteMany: jest.fn() },
    leave: { findMany: jest.fn(), create: jest.fn(), deleteMany: jest.fn() },
    timetable: { findMany: jest.fn(), create: jest.fn(), deleteMany: jest.fn() },
    classSubject: { findMany: jest.fn(), create: jest.fn(), deleteMany: jest.fn() },
  };
